...
from v1.utils.marshmallow_mongoengine import fields as ma_fields
from v1.utils.marshmallow_mongoengine.conversion import params
from v1.utils.marshmallow_mongoengine.exceptions import ModelConversionError
...
class MapBuilder(MetaFieldBuilder):
    ...
    def _get_marshmallow_field_cls(self):
        # Recursive build of marshmallow schema
        from v1.utils.marshmallow_mongoengine.convert import convert_field
